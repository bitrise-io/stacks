...
The [Ubuntu 22.04 stack](../stack_reports/linux-docker-android-22.04/) has been deprecated on June 10, 2026, and will be removed on April 8, 2027.

{{< hint info >}}
This stack is marked as a frozen stack and won't receive updates anymore. Your builds continue to run on this stack until the removal date. Read more about our [stack update policy here](https://devcenter.bitrise.io/en/infrastructure/build-stacks/linux-stack-update-policy.html).
{{< /hint >}}

## Migration guide

We recommend migrating your workflows to the [Ubuntu Noble 24.04 - Bitrise 2025 Edition stack](/stack_reports/ubuntu-noble-24.04-bitrise-2025-android/), which is the successor of the newly deprecated Ubuntu stack, and is the new stable stack. You can also switch to our edge stack, [Ubuntu Resolute 26.04 - Bitrise 2026 Edition](../stack_reports/ubuntu-resolute-26.04-bitrise-2026-android/), which is the next generation of our Linux stacks, but it may have more breaking changes and less stability than the stable stack.
...
Go 1.25 is now the default active version, while Go 1.24 is also installed. Go 1.21 and 1.22 are no longer installed.
...
Python 3.13 is the new preinstalled version, replacing Python 3.12. Python 3.14 is also installed.
