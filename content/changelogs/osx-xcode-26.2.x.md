---
title: Xcode 26.2 with changelog
...
Check out the [stack report page]({{% ref "/stack_reports/osx-xcode-26.2.x.md" %}}) for a snapshot of what is currently installed.
...
### Stack update `v2026-02-26` (released 2026-02-27)

- Added ndk version: `27.1.12297006`
...
Initial stack release with [Xcode 26.2](https://developer.apple.com/documentation/xcode-release-notes/xcode-26_2-release-notes) (build `17B100`)
